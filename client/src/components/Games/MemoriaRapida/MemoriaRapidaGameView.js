// client/src/components/Games/MemoriaRapida/MemoriaRapidaGameView.js
...
import MemoriaRapidaFinalView from './MemoriaRapidaFinalView';
...
const MemoriaRapidaGameView = ({ studentId = 'student_001' }) => {
    ...
    if (gameState === 'completed' && gameResult) {
        return <MemoriaRapidaFinalView result={gameResult} activity={activity} />;
    }

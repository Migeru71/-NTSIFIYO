    ...
    async function loadActivities(page = 0) {
        ...
        if (result.success) {
            ...
            if (Array.isArray(data)) {
                setActivities(data);
                setPageData({ totalPages: 1, number: 0, first: true, last: true });
            } else {
            ...
            <div className="w-full">
                <div className="max-w-6xl mx-auto p-8">
                    ...
                    <header className="mb-10 text-center">
                        ...
                        <p className="text-indigo-600 font-medium">Completa las actividades asignadas por tu maestro para ganar experiencia</p>
                    </header>

...
**Mecánica:**
- ⏱️ **60 segundos** de tiempo límite
- ➡️ Desliza a la **derecha** si la palabra coincide con la imagen
- ⬅️ Desliza a la **izquierda** si no coincide
- 🔥 Acumula **combos** para multiplicar tu puntaje
- ⚡ La velocidad **aumenta** conforme aciertas
...
│   └── src/
│       ├── components/
│       │   ├── Dashboard/      # Sidebars, paneles de control
│       │   ├── Games/
│       │   │   ├── Memorama/   # Memoria Rápida (swipe game)
│       │   │   └── Quiz/       # Quizzes interactivos
│       │   ├── Navbar.js       # Barra de navegación
│       │   └── Hero.js         # Landing page
│       ├── data/               # Mock data (actividades, usuarios)
